...
import { format, Heading, IComponentNodeProps, IModuleProps, INodeProps, ISingleSlideCarouselProps, NodeTag, SingleSlideCarousel } from '@msdyn365-commerce-modules/utilities';
...
class ProductCollection extends React.PureComponent<IProductCollectionProps<{}>> {
    public render(): JSX.Element | null {
        ...
        const headingComponent = heading && <Heading className='ms-product-collection__heading' headingTag={heading.tag} text={heading.text} />;
