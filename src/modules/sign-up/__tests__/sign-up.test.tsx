...
const mockConfig: ISignUpConfig = {
    ...
    disclaimer: '<p>By creating an account, you agree to Fabrikam’s <a href="TermsOfUser" class="c-hyperlink">Terms of Use</a> and accept our <a href="privacypolicy" class="c-hyperlink">Privacy Policy</a>.</p>'
};
